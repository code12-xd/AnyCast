...
public interface OnRecordCallBack {
    ...
    int onSaveRecord(MediaSource dataSource, int record);

    int onGetRecord(MediaSource dataSource);

    int onResetRecord(MediaSource dataSource);

    int onRemoveRecord(MediaSource dataSource);
