...
import com.code12.anycast.View.adapters.NormalVAdapter;
...
public class NormalVFragment extends BaseFragment
{
    RecyclerView mRecyclerView;
    SwipeRefreshLayout mSwipeRefreshLayout;
    CustomEmptyView mCustomEmptyView;
    private NormalVAdapter mGameAdapter;

    public static NormalVFragment newInstance()
    {
        return new NormalVFragment();
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(NormalViewModel.class);
    }
    ...
    protected void initRecyclerView() {
        mGameAdapter = new NormalVAdapter(getActivity());
    ...
    private void loadData() {
        mViewModel.loadDataObservable().subscribe(vInfo -> {
            mGameAdapter.setVideoInfo((NormalVListInfo)vInfo);
            finishTask();
        }, throwable -> {
            initEmptyView();
        });
